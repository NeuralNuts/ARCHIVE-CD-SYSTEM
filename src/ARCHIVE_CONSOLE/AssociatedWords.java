...
//</editor-fold>
    ...
    public void WordAssociationTable(SpringLayout myPanelLayout)
    {
        ...
        JTableInputModel input = new JTableInputModel();

        file.ReadDataFromFile();

        // Create some data
        ArrayList<Object[]> dataValues = new ArrayList();
        dataValues.add(new Object[] {input.ID});
        dataValues.add(new Object[] {input.Title});
        dataValues.add(new Object[] {input.Author});
        dataValues.add(new Object[] {input.Section});
        dataValues.add(new Object[] {input.X});
        dataValues.add(new Object[] {input.Y});
        dataValues.add(new Object[] {input.BarCode});
        dataValues.add(new Object[] {input.Section});
        dataValues.add(new Object[] {input.Description});
        dataValues.add(new Object[] {input.OnLoan});

        // constructor of JTable model
        wordModel = new CDModel.MyModel(dataValues, columnNames);
    ...
    class MyModel1 extends AbstractTableModel
    {
        ...
        // constructor
        MyModel1(ArrayList<Object[]> obj, String[] header)
        {
            // save the header
            this.header = header;
            // and the data
